 ...
 *         &lt;element name="datProcessInfo" type="{http://sphinx.dat.de/services/VehicleRepairService}datProcessInfo" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "calculateContractRequest", namespace = "http://sphinx.dat.de/services/VehicleRepairService", propOrder = {
    "comment",
    "contractID",
    "datProcessInfo",
    "includeAttachments",
