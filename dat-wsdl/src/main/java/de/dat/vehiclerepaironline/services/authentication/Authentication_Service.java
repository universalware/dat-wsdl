 ...
 * 
 */
@WebServiceClient(name = "Authentication", targetNamespace = "http://sphinx.dat.de/services/Authentication", wsdlLocation = "http://www.dat.de/VehicleRepairOnline/services/Authentication?wsdl")
    ...
    extends Service
{
    ...
    private final static QName AUTHENTICATION_QNAME = new QName("http://sphinx.dat.de/services/Authentication", "Authentication");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://www.dat.de/VehicleRepairOnline/services/Authentication?wsdl");
    ...
    public Authentication getAuthenticationPort() {
        return super.getPort(new QName("http://sphinx.dat.de/services/Authentication", "AuthenticationPort"), Authentication.class);
    }
    ...
    public Authentication getAuthenticationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sphinx.dat.de/services/Authentication", "AuthenticationPort"), Authentication.class, features);
    }
