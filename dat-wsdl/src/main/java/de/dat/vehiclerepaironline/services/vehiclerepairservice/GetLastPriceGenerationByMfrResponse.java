...
/**
 * <p>Java-Klasse für getLastPriceGenerationByMfrResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getLastPriceGenerationByMfrResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getLastPriceGenerationByMfrResponse", namespace = "http://sphinx.dat.de/services/VehicleRepairService", propOrder = {
    "priceDates"
})
public class GetLastPriceGenerationByMfrResponse {
