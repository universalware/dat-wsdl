...
/**
 * <p>Java-Klasse für getNewContractsResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getNewContractsResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getNewContractsResponse", namespace = "http://sphinx.dat.de/services/GlassRep", propOrder = {
    "result"
})
public class GetNewContractsResponse {
