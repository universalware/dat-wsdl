 ...
 *       &lt;sequence>
 *         &lt;element name="locale" type="{http://sphinx.dat.de/services/SpareParts}locale"/>
...
@XmlType(name = "abstractSelectionRequest", namespace = "http://sphinx.dat.de/services/SpareParts", propOrder = {
    "locale",
    "sessionID"
})
@XmlSeeAlso({
    AbstractCoverageRequest.class
})
