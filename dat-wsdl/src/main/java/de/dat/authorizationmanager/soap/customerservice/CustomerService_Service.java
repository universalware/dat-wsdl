 ...
 * 
 */
@WebServiceClient(name = "CustomerService", targetNamespace = "http://sphinx.dat.de/cs", wsdlLocation = "http://www.dat.de/AuthorizationManager/soap/CustomerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICE_QNAME = new QName("http://sphinx.dat.de/cs", "CustomerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://www.dat.de/AuthorizationManager/soap/CustomerService?wsdl");
    ...
    public CustomerService getCustomerService() {
        return super.getPort(new QName("http://sphinx.dat.de/cs", "CustomerService"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerService(WebServiceFeature... features) {
        return super.getPort(new QName("http://sphinx.dat.de/cs", "CustomerService"), CustomerService.class, features);
    }
