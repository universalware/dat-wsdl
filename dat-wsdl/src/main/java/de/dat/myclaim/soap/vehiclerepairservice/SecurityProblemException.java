...
/**
 * <p>Java-Klasse für SecurityProblemException complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="SecurityProblemException">
 *   &lt;complexContent>
...
@XmlType(name = "SecurityProblemException", namespace = "http://www.dat.eu/myClaim/soap/v2/VehicleRepairService", propOrder = {
    "httpStatus",
    "message"
})
