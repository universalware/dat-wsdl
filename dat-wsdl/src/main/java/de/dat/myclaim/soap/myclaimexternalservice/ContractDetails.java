...
/**
 * <p>Java-Klasse für contractDetails complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="complexTemplateData" type="{http://www.dat.eu/myClaim/soap/MyClaimExternalService}complexTemplateData" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="customTemplateData">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="dossier" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;all>
 ...
 *         &lt;element name="participatingPartners">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "contractDetails", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService", propOrder = {
    "complexTemplateData",
    "customTemplateData",
    "dossier",
    "networkType",
...
public class ContractDetails {
    ...
    protected List<ComplexTemplateData> complexTemplateData;
    @XmlElement(namespace = "", required = true)
    protected ContractDetails.CustomTemplateData customTemplateData;
    @XmlElement(namespace = "")
    protected ContractDetails.Dossier dossier;
    @XmlElement(namespace = "")
    protected String networkType;
    @XmlElement(namespace = "", required = true)
    protected ContractDetails.ParticipatingPartners participatingPartners;
    @XmlElement(namespace = "")
    ...
    /**
     * Gets the value of the complexTemplateData property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the complexTemplateData property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getComplexTemplateData().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ComplexTemplateData> getComplexTemplateData() {
        if (complexTemplateData == null) {
            complexTemplateData = new ArrayList<ComplexTemplateData>();
        }
        return this.complexTemplateData;
    }

    /**
     * Ruft den Wert der customTemplateData-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link ContractDetails.CustomTemplateData }
     *     
     */
    public ContractDetails.CustomTemplateData getCustomTemplateData() {
        return customTemplateData;
    }

    /**
     * Legt den Wert der customTemplateData-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link ContractDetails.CustomTemplateData }
     *     
     */
    public void setCustomTemplateData(ContractDetails.CustomTemplateData value) {
        this.customTemplateData = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link ContractDetails.Dossier }
     *     
     */
    public ContractDetails.Dossier getDossier() {
        return dossier;
    }
     ...
     *     
     */
    public void setDossier(ContractDetails.Dossier value) {
        this.dossier = value;
    }
    ...
    /**
     * Ruft den Wert der participatingPartners-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link ContractDetails.ParticipatingPartners }
     *     
     */
    public ContractDetails.ParticipatingPartners getParticipatingPartners() {
        return participatingPartners;
    }

    /**
     * Legt den Wert der participatingPartners-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link ContractDetails.ParticipatingPartners }
     *     
     */
    public void setParticipatingPartners(ContractDetails.ParticipatingPartners value) {
        this.participatingPartners = value;
    }
    ...
    public static class CustomTemplateData {
        ...
        @XmlElement(namespace = "")
        protected List<ContractDetails.CustomTemplateData.Entry> entry;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ContractDetails.CustomTemplateData.Entry }
         * 
         * 
         */
        public List<ContractDetails.CustomTemplateData.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<ContractDetails.CustomTemplateData.Entry>();
            }
            return this.entry;
        }
    ...
    public static class Dossier {
        ...
        @XmlElement(name = "Name", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldString name;
        @XmlElement(name = "Description", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldString description;
        @XmlElement(name = "UUID", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldString uuid;
        @XmlElement(name = "ExternalId", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldString externalId;
        @XmlElement(name = "IdSD2", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldString12 idSD2;
        @XmlElement(name = "IdSDo", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldInteger idSDo;
        @XmlElement(name = "IdSD3Local", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldInteger idSD3Local;
        @XmlElement(name = "DossierId", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldInteger dossierId;
        @XmlElement(name = "IdSD3Network", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldInteger idSD3Network;
        @XmlElement(name = "IdExtern", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldString40 idExtern;
        @XmlElement(name = "Country", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService", required = true)
        protected FieldString3 country;
        @XmlElement(name = "Language", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService", required = true)
        protected FieldString5 language;
        @XmlElement(name = "DataVersion", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldDecimal dataVersion;
        @XmlElement(name = "Currency", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldString3 currency;
        @XmlElement(name = "DatCustomerId", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldString10 datCustomerId;
        @XmlElement(name = "MerchandId", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldDecimal merchandId;
        @XmlElement(name = "DossierType", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldString dossierType;
        @XmlElement(name = "DossierOrigin", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldString dossierOrigin;
        @XmlElement(name = "CreateDate", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldDateTime createDate;
        @XmlElement(name = "CreateUser", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldString createUser;
        @XmlElement(name = "ChangeDate", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldDateTime changeDate;
        @XmlElement(name = "ChangeUser", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldString changeUser;
        @XmlElement(name = "CDYear", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldInteger cdYear;
        @XmlElement(name = "CDMonth", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldInteger cdMonth;
        @XmlElement(name = "DatCustomerAddress", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        ...
        @XmlElement(name = "VAT")
        protected VAT vat;
        @XmlElement(name = "Management", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        ...
        @XmlElement(name = "ChangeUserId", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldInteger changeUserId;
        @XmlElement(name = "CreateUserId", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldInteger createUserId;
        @XmlElement(name = "WearCalculation", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
        protected FieldBoolean wearCalculation;
        @XmlElement(name = "InsuranceClaim", namespace = "http://www.dat.eu/myClaim/soap/MyClaimExternalService")
    ...
    public static class ParticipatingPartners {

        @XmlElement(namespace = "")
        protected List<ContractDetails.ParticipatingPartners.Entry> entry;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ContractDetails.ParticipatingPartners.Entry }
         * 
         * 
         */
        public List<ContractDetails.ParticipatingPartners.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<ContractDetails.ParticipatingPartners.Entry>();
            }
            return this.entry;
        }
