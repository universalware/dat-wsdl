...
@XmlRootElement(name = "labourRateDatabase", namespace = "http://myclaim.dat.eu/schema/v1.0/DATrepdb.xsd")
public class LabourRateDatabase {
    ...
    @XmlElement(namespace = "http://myclaim.dat.eu/schema/v1.0/DATrepdb.xsd")
    protected List<LabourRateDatabase.RateList> rateList;
    @XmlElement(namespace = "http://myclaim.dat.eu/schema/v1.0/DATrepdb.xsd")
    protected List<LabourRateDatabase.PartnerList> partnerList;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LabourRateDatabase.RateList }
     * 
     * 
     */
    public List<LabourRateDatabase.RateList> getRateList() {
        if (rateList == null) {
            rateList = new ArrayList<LabourRateDatabase.RateList>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LabourRateDatabase.PartnerList }
     * 
     * 
     */
    public List<LabourRateDatabase.PartnerList> getPartnerList() {
        if (partnerList == null) {
            partnerList = new ArrayList<LabourRateDatabase.PartnerList>();
        }
