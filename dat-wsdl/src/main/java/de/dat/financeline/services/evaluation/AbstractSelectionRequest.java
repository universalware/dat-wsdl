 ...
 *       &lt;sequence>
 *         &lt;element name="locale" type="{http://sphinx.dat.de/services/Evaluation}locale"/>
...
@XmlType(name = "abstractSelectionRequest", namespace = "http://sphinx.dat.de/services/Evaluation", propOrder = {
    "locale",
    "sessionID"
})
@XmlSeeAlso({
