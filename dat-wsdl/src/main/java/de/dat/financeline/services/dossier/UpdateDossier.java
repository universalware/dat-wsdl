...
/**
 * <p>Java-Klasse für updateDossier complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="updateDossier">
 *   &lt;complexContent>
...
@XmlType(name = "updateDossier", namespace = "http://sphinx.dat.de/services/Dossier", propOrder = {
    "dossierId",
    "coverage"
})
