 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://sphinx.dat.de/services/Evaluation}priceFocusSelectionRequest">
 *       &lt;sequence>
...
@XmlType(name = "constructionPeriodSelectionRequest", namespace = "http://sphinx.dat.de/services/Evaluation", propOrder = {
    "container"
})
@XmlSeeAlso({
