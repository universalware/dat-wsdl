...
/**
 * <p>Java-Klasse für getDataCountriesForUsedVehicleForecastResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getDataCountriesForUsedVehicleForecastResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getDataCountriesForUsedVehicleForecastResponse", namespace = "http://sphinx.dat.de/services/Evaluation", propOrder = {
    "dataCountry"
})
public class GetDataCountriesForUsedVehicleForecastResponse {
