...
/**
 * <p>Java-Klasse für getDataCountriesForVehicleEvaluationResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getDataCountriesForVehicleEvaluationResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getDataCountriesForVehicleEvaluationResponse", namespace = "http://sphinx.dat.de/services/Evaluation", propOrder = {
    "dataCountry"
})
public class GetDataCountriesForVehicleEvaluationResponse {
