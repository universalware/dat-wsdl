...
/**
 * <p>Java-Klasse für createExportFormatDataResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="createExportFormatDataResponse">
 *   &lt;complexContent>
...
@XmlType(name = "createExportFormatDataResponse", namespace = "http://sphinx.dat.de/services/Dossier", propOrder = {
    "_return"
})
public class CreateExportFormatDataResponse {
