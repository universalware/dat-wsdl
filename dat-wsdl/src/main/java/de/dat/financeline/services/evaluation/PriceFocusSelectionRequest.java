 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://sphinx.dat.de/services/Evaluation}basicSelectionRequest">
 *       &lt;sequence>
...
@XmlType(name = "priceFocusSelectionRequest", namespace = "http://sphinx.dat.de/services/Evaluation", propOrder = {
    "datECode"
})
@XmlSeeAlso({
