...
/**
 * <p>Java-Klasse für createDossierResponse complex type.
 * 
...
@XmlType(name = "createDossierResponse", namespace = "http://sphinx.dat.de/services/Dossier", propOrder = {
    "vxs"
})
public class CreateDossierResponse {

    @XmlElement(name = "VXS", namespace = "")
    protected CreateDossierResponse.VXS vxs;
     ...
     * @return
     *     possible object is
     *     {@link CreateDossierResponse.VXS }
     *     
     */
    public CreateDossierResponse.VXS getVXS() {
        return vxs;
    }
     ...
     *     
     */
    public void setVXS(CreateDossierResponse.VXS value) {
        this.vxs = value;
    }
